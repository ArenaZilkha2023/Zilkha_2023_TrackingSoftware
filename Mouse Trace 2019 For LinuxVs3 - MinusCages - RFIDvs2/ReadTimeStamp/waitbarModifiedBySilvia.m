function fout = waitbarModifiedBySilvia(x,whichbar, varargin)
...
if nargout==1,
    ...
    function createWaitbar(varargin)
        ...
        handles.figure = figure(...
            ...
            'DockControls', 'off', ...
            'Visible','off');
         c = get(handles.figure,'Children');
%   
        set(c,'Units','pixels','Parent', h.FigVideoChild);
        set(c,'Position',[900,250,750,20]);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
