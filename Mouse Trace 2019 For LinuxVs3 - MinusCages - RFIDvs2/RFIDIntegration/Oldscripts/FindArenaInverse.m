function [XAssignment,YAssignment, XAssignmentPixel,YAssignmentPixel,IindicateNoSureCoord,OrientationAssignment,velocityFinal,velocityX,velocityY]=FindArenaInverse(IndexArena,AntennaNumber,AntennaCoord,DeltaTimeRFID,countFrames,....
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
 ...
 if countFrames < LastFrame
        if ~isempty(find(IindicateNoSureCoord==0)) % this is done only with sure candidates  coordinates
          IindicateNoSureCoord=CheckingValidityInverse(countFrames,find(IindicateNoSureCoord==0),XAssignment(find(IindicateNoSureCoord==0)),YAssignment(find(IindicateNoSureCoord==0)),.....
                      ...
                      VelocityThreshold,IindicateNoSureCoord,VelLastFrame,FactorAcceleration,OrientationLastFrame(find(IindicateNoSureCoord==0)),...
                      OrientationAssignment(find(IindicateNoSureCoord==0)),MinimumAngleTolerance,LastFrame);
        end         
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if countFrames~=LastFrame & any(IindicateNoSureCoord)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   if countFrames<LastFrame
    ...
    [IindicateNoSureCoord,velocityFinal,velocityX,velocityY]=CheckingValidityFinalInverse(countFrames,XAssignment,YAssignment,.....
                      ...
                      OrientationLastFrame,OrientationAssignment,MinimumAngleTolerance,LastFrame);
...
%    end
  ...
  if countFrames~=LastFrame & ~isempty(find(XLastFrame==1e+6))%& length(find(XLastFrame==1e+6))>1
