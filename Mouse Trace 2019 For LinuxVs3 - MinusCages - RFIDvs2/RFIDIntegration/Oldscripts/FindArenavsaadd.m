 ...
 % %%%%%%%%%%%%%%%%%%%%%%%%%% If antenna assignment is equal to last frame assignment the result is sure%%%%%%%%%%%%%%%%%%%               
    % find the assignment of all the data
       % Arrange Matrix with distance and orientations  
             ...
             % Minimize the matrix
                [assignmentFSecondAll,~]=munkresForMiceTracer(MatrixToMinimizeSecondAll); 
             % Find similarity with assignment of rfid
             IndexCoincidenceRFIDLastFrame=find(assignmentF==assignmentFSecondAll); % use later for arrangement
    end   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   if countFrames>1
    ...
    [IindicateNoSureCoord,velocityFinal]=CheckingValidityFinal(countFrames,XAssignment,YAssignment,.....
                      ...
                      OrientationLastFrame,OrientationAssignment,MinimumAngleTolerance,IndexCoincidenceRFIDLastFrame);
