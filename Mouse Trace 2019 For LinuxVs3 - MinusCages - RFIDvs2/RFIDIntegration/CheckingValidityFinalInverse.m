function   [IindicateNoSureCoord,velocityFinal,velocityX,velocityY]=CheckingValidityFinalInverse(countFrames,XAssignment,YAssignment,.....
...
% The idea is to check the validity of the results after all the manipulation                
 %% ------------------Begin calculation-----------------------
  ...
  if countFrames<LastFrame-1 
   ...
   elseif countFrames==LastFrame-1
       [velocityFinal,velocityX,velocityY]=VelocityCalculation(XAssignment,....
                                       YAssignment,.....
                                        XLastFrame,YLastFrame,...
                                        TimeInitial,TimeFinal);
