...
BinaryImage = imbinarize(DifImage,level);
BinaryImage([557:557+19],[265:265+170])=0; %remove the date
%[ 265.5100  557.5100  176.9800   18.9800]
...
PixelToEliminate=STATS(find(RatioElongation>MinElongationFactor)).PixelIdxList;
...
% 
    ...
    %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%% Reconsider the cases in which the 
